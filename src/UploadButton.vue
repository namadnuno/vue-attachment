<template>
  <button type="button" @click="$emit('click')" :class="{'is-loading' : sending }" :disabled="sending"  class="uploader">
                <span class="icon">
                ...
                <span class="progress" v-if="sending" :style="{width: progress + '%'}"></span>
            </button>
</template>
